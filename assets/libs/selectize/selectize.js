      ...
      (Sifter.prototype.getSortFunction = function (t, n) {
        ...
        return (s = d.length)
          ? 1 === s
            ...
            : function (t, e) {
                for (var n, i = 0; i < s; i++)
                  if (((n = d[i].field), (n = a[i] * cmp(u(n, t), u(n, e)))))
                    return n;
                return 0;
              }
          : null;
            ...
            t.type &&
              ...
              i === KEY_DELETE || i === KEY_BACKSPACE
                ? (o = getInputSelection(s[0])).length
                  ? (e =
                      e.substring(0, o.start) + e.substring(o.start + o.length))
                  : i === KEY_BACKSPACE && o.start
                  ? (e = e.substring(0, o.start - 1) + e.substring(o.start + 1))
                  : i === KEY_DELETE &&
                    void 0 !== o.start &&
                    (e = e.substring(0, o.start) + e.substring(o.start + 1))
                : n &&
                  ((i = t.shiftKey),
    ...
    Selectize = function (t, e) {
      ...
      if (
        ...
        $.extend(o, {
          ...
          tagType:
            "select" === s.tagName.toLowerCase() ? TAG_SELECT : TAG_INPUT,
          rtl: /rtl/i.test(r),
    ...
    $.extend(Selectize.prototype, {
        ...
        var e = this,
          ...
          d =
            ((d = s.attr("id")) &&
              ...
              $("label[for='" + d + "']").attr("for", d + "-selectized")),
      ...
      positionDropdown: function () {
        var t = this.$control,
          ...
          t =
            ((e.top += t.outerHeight(!0)), t[0].getBoundingClientRect().width);
